...
console.log(
  chalk.hex('#FF073A').italic('✩░▒▓▆▅▃▂▁𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐓𝐎 𝐁𝐀𝐈𝐋𝐄𝐘𝐒 𝐅𝐀𝐇𝐑𝐈𝐆𝐄𝐍𝐙𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋▁▂▃▅▆▓▒░✩\n') +
  chalk.hex('#00F2FF').italic(' last updated • 19 𝘍𝘦𝘣𝘶𝘢𝘳𝘪 2026\n') +
  chalk.hex('#00F2FF').italic('   Credits by @FahriGenzOffc\n') +
  chalk.hex('#00F2FF').italic('   telegram: @FahriGenz\n\n') +
  chalk.hex('#FF073A').italic('Terimakasih Telah Menggunakan Baileys FahriGenzOffc♡\n')
);
